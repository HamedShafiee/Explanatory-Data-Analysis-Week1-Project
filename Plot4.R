...
#plot-left up
plot(range,as.numeric(newconsdata$Global_active_power), type="l",xlab="",ylab="Global Active Power")
#plot-Right up
plot(range,as.numeric(newconsdata$Voltage), type="l",xlab="datetime",ylab="Voltage")
#plot-Left Bottom
...
#plot-Right Bottom
plot(range,as.numeric(newconsdata$Global_reactive_power), type="l",xlab="datetime",ylab="Global_reActive_power")
dev.off()
